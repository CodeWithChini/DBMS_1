...
SP_RENAME 'DEPOSIT_DETAIL.ADATE', 'DEPOSIT_DETAIL.AOPENDATE';
...
SP_RENAME 'DEPOSIT_DETAIL.CNAME', 'DEPOSIT_DETAIL.CUSTOMERNAME';
...
SP_RENAME 'STUDENT_DETAIL.Enrollment_No', 'STUDENT_DETAIL.ENO'
...
DELETE FROM DEPOSIT_DETAIL
WHERE BNAME = 'AJNI' AND BNAME = 'POWAI'
...
INSERT INTO EMPLOYEE_MASTER (EMPN0, EMPNAME, JOININGDATE, SALARY, CITY)
				VALUES(101, 'KAYUR', '2002-5-1', 12000, 'RAJKOT'),
